...
import { runMutatorOrchestrator } from "@/lib/agents/orchestrator/mutator";
import type { TopicsMap } from "@/lib/agents/agents/topic-helpers";

export const runtime = "nodejs";
export const dynamic = "force-dynamic";

// ─── Database Mutator Orchestrator API Route ──────────────────────────────────
//
// POST /api/orchestrator/mutator  — runs the database mutator orchestrator
// GET  /api/orchestrator/mutator  — SSE stream of agent topics for a given runId
//
// All agent logic lives in lib/agents/orchestrator/mutator.ts
// ─────────────────────────────────────────────────────────────────────────────
